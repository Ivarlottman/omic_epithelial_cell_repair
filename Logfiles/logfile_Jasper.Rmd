...
```{r}
dotplot(gsea_kegg, showCategory=5, split=".sign") + facet_grid(.~.sign) + theme(axis.text.y = element_text(size = 9))+ labs(title = 'Control vs extracellular vesicles')

```

```{r}
ridgeplot(gsea_kegg, showCategory=5, fill = "p.adjust")+ theme_minimal() + labs(title = 'Control vs extracellular vesicles')
```
...
```{r}
dotplot(gsea_kegg_2, showCategory=5, split=".sign") + facet_grid(.~.sign) + theme(axis.text.y = element_text(size = 9))+ labs(title = 'Control vs soluble factors')
```

```{r}
ridgeplot(gsea_kegg_2, showCategory = 10, fill = "p.adjust")+ theme_minimal()+ labs(title = 'Control vs soluble factors')
```
...
```{r}
dotplot(gsea_kegg_3, showCategory=5, split=".sign") + facet_grid(.~.sign) + theme(axis.text.y = element_text(size = 9)) + labs(title = 'Extracellular factors vs soluble factors')
```

```{r}
ridgeplot(gsea_kegg_3, showCategory = 5, fill = "p.adjust")+ theme_minimal()+ theme(axis.text.y = element_text(size = 9))+ labs(title = 'Extracellular factors vs soluble factors')
```
