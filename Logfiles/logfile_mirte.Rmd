...
Today we discussed which research question we will use for this project. Ofcourse this is something that can change later on but for now we settled on: __deze onderzoeksvraag__
